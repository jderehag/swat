...
declare module Fancytree {
    interface Fancytree {
        ...
        /** [ext-filter] Dimm or hide children.
         * @returns {integer} count
         */
        ...
        /** Generate INPUT elements that can be submitted with html forms. In selectMode 3 only the topmost selected children are considered. */
        ...
        /** [ext-clones] Return all children with a given refKey (null if not found).
         * 
        ...
        /** Return an array of selected children.
         * 
        ...
        /** Render tree (i.e. create DOM elements for all top-level children).
         * 
        ...
        /** Return all children as nested list of NodeData.
         * 
    ...
    interface FancytreeNode {
        ...
        /**
         * Append (or insert) a list of child children.
         * 
         * @param children array of child node definitions (also single child accepted)
         * @param insertBefore child node to insert children before. If omitted, the new children is appended.
         ...
         * 
         * @param children array of child node definitions (also single child accepted)
         * @param insertBefore key of the child node to insert children before. If omitted, the new children is appended.
         * @returns The first child added.
         */
         ...
         * 
         * @param children array of child node definitions (also single child accepted)
         * @param insertBefore index of the child node to insert children before. If omitted, the new children is appended.
         * @returns The first child added.
         */
        ...
        /** Modify existing child children. */
        applyPatch(patch: NodePatch): JQueryPromise<any>;

        /** Collapse all sibling children. */
        ...
        /** Find all children that contain `match` in the title.
         * 
        ...
        /** Fix selection status for multi-hier mode. Only end-children are considered to update the descendants branch and parents. Should be called after this node has loaded new children or after children have been modified using the API. */
        ...
        /** Return the list of child children (undefined for unexpanded lazy children). */
        getChildren(): FancytreeNode[];

        /** [ext-clones] Return a list of clone-children or null. */
        ...
        /**Return an array of all parent children (top-down).
         * 
        ...
        /** Return true if node is lazy and loaded. For non-lazy children always return true.  */
        isLoaded(): boolean;
        ...
        /** Return true if node is lazy and not yet loaded. For non-lazy children always return false. */
        isUndefined(): boolean;

        /** Return true if all parent children are expanded. Note: this does not check whether the node is scrolled into the visible part of the screen. */
        isVisible(): boolean;

        /** Load all children of a lazy node if neccessary. The *expanded* state is maintained. 
         * 
         * @param forceReload Pass true to discard any existing children before.
         */
        ...
        /** Remove all child children and descendents. This converts the node into a leaf.
         ...
         * @param deep pass true to sort all descendant children
         */
         ...
         * 
         * @param recursive include child children.
        ...
        /** 
         * Call fn(node) for all child children.
        ...
        /**
         * Call fn(node) for all child children and recursively load lazy children.
         * Note: If you need this method, you probably should consider to review your architecture! Recursivley loading children is
        ...
        /**
         * Call fn(node) for all parent children, bottom-up, including invisible system root.
