...
interface JQueryStatic {
    ...
    /**
     * Parses a string into an array of DOM children.
     *
...
interface JQuery {
    ...
    */
    ...
    /**
     * Remove all child children of the set of matched elements from the DOM.
     */
    empty(): JQuery;
    ...
    /**
     * Get the children of each element in the set of matched elements, including text and comment children.
     */
    contents(): JQuery;
