...
d3plus.shape.rect = function(vars,selection,enter,exit) {
   ...
   * Dani's patch here
   */
   // d3plus.shape.rect.elements_for_dani = selection.selectAll("rect.d3plus_data");
  ...
  //   // .attr("data-component_type", function(d){
  //   //   return d.component_type;
  //   // })
  //   // .attr("data-metric_type", function(d){
  //   //   return d.metric_type;
  //   // })
  //   // .attr("data-parent_id", function(d){
  //   //   return d.parent_id;
  //   // })
  //   // .attr("data-grandparent_id", function(d) {
  //   //   return d.grandparent_id;
  //   // })
  //   .attr("data-name", function(d){
  //     return d.name;
  //   })    
  //   .attr("data-nloc", function(d){
  //     return d.nloc;
  //   })    
  //   .attr("data-metric_value", function(d){
...
d3plus.visualization.network = function(vars) {
  ...
  max_size = max_size * vars.children.overlap
